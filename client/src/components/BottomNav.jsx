    ...
    <nav className="fixed bottom-0 left-0 right-0 w-full z-50 pb-safe bg-surface/95 backdrop-blur-xl border-t border-surface-container shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
      <div className="flex justify-around items-center h-16 max-w-md mx-auto">
        ...
        >
          ...
          <span className="text-label-md font-label-md text-[11px]">Home</span>
        </button>
        ...
        >
          ...
          <span className="text-label-md font-label-md text-[11px]">Trending</span>
        </button>
        ...
        >
          ...
          <span className="text-label-md font-label-md text-[11px]">About</span>
        </button>
      </div>
    </nav>
  );
